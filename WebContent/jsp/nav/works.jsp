...
<div class="navi_list js_collapsible">
	...
	<div class="categ_link js_tab_work">
		<a href="jsp/nav/my_favorite_works.jsp" class="current"><fmt:message
				key="nav.works.my_favorite_works" />
		</a> <a href="jsp/nav/my_recent_instances.jsp" class=""><fmt:message
				key="nav.works.my_recent_instances" />
		</a> <a href="jsp/nav/my_all_works.jsp" class=""><fmt:message
				key="nav.works.my_all_works" />
		</a>
	</div>
	<div id='my_works'>
